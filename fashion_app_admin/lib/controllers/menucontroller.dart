...
class MenuControllers extends ChangeNotifier {
  ...
  final GlobalKey<ScaffoldState> _editCategoryScaffoldKey = GlobalKey<ScaffoldState>();
  final GlobalKey<ScaffoldState> _getDetailOrdersScaffoldKey = GlobalKey<ScaffoldState>();
  // Getters

  GlobalKey<ScaffoldState> get getAllCategoryScaffoldKey => _allCategoryScaffoldKey;
  GlobalKey<ScaffoldState> get getEditCategoryScaffoldKey => _editCategoryScaffoldKey;
  ...
  GlobalKey<ScaffoldState> get getDetailOrdersScaffoldKey => _getDetailOrdersScaffoldKey;
  // Callbacks
  void controlGetDetailOrderMenu() {
    if (!_getDetailOrdersScaffoldKey.currentState!.isDrawerOpen) {
      _getDetailOrdersScaffoldKey.currentState!.openDrawer();
    }
  }
  ...
  }void controlEditCategoryMenu() {
    if (!_editCategoryScaffoldKey.currentState!.isDrawerOpen) {
      _editCategoryScaffoldKey.currentState!.openDrawer();
    }
  }
  void controlAllCategoryMenu() {
    if (!_allCategoryScaffoldKey.currentState!.isDrawerOpen) {
      _allCategoryScaffoldKey.currentState!.openDrawer();
    }
  }
