          ...
          DrawerHeader(
            child: Column(
              children: [
                ...
                TextWidget(textSize: 16,text: "Tên: $_name",maxLines: 1, color: color, isTitle: true,),
                TextWidget(textSize: 16,text: "Email: $_email", color: color, isTitle: false,maxLines: 1),
                const SizedBox(height: 10,),
              ],
            ),
