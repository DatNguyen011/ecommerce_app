...
class EditProductScreen extends StatefulWidget {
  const EditProductScreen(
      {Key? key,
        ...
        required this.isPiece, required this.number})
      : super(key: key);

  final String id, title, price, productCat, imageUrl, number;
...
class _EditProductScreenState extends State<EditProductScreen> {
    ...
    if (isValid) {
      ...
      try {
        ...
        await Fluttertoast.showToast(
          msg: "Sản phẩm đã cập nhật thành công",
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      key: context.read<MenuControllers>().getEditProductScaffoldKey,
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Header(
                        showTexField: false,
                        fct: () {
                          context.read<MenuControllers>().controlEditProductsMenu();
                        },
                        title: 'Sửa sản phẩm',
                      ),
                    ),
  ...
  Widget catDropDownWidget(Color color) {
